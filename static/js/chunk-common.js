          ...
          , k = function() {
            ...
            return Object(a["a"])(e, [{
                ...
                value: function(e, t) {
                    ...
                    var i = this
                      , n = new Uint8Array(e.slice(0, 1))[0];
                    console.log("ccmz version:", n);
                    var s = new Uint8Array(e.slice(1));
                    1 == n ? g.loadAsync(s).then((function(e) {
                        e.file("data.ccxml").async("string").then((function(n) {
                            var s = JSON.parse(n);
                            t(s),
                            e.file("data.ccmid").async("string").then((function(e) {
                                i.initPlayer(e)
                            }
                            ))
                        }
                    ...
                    )) : 2 == n && (s = s.map((function(e) {
                        return e % 2 == 0 ? e + 1 : e - 1
                    }
                    )),
                    g.loadAsync(s).then((function(e) {
                        e.file("score.json").async("string").then((function(n) {
                            var s = JSON.parse(n);
                            t(s),
                            e.file("midi.json").async("string").then((function(e) {
                                i.initPlayer(e)
                            }
                            ))
                        }
...
//                console.log(this.musScore);
        ...
        var je = i("94a1")
          ...
          , Ne = {
            ...
            props: ["ccmz", "showVersion", "noPrintWatermark", "noPrintQrcode", "defaultJianpu", "defaultReadingMode", "defaultWaterfallMode", "defaultDisableTouchSeek", "defaultLocked", "defaultCovered", "defaultBackgroundColor", "appVersion","defaultfilename"],
            data: function(e) {
            ...
            mounted: function() {
                ...
                this.ccmz && this.controller.readTextFile(this.ccmz, this.readingMode, this.onDataCallback),
